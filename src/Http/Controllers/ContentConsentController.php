...
class ContentConsentController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->title = 'utility-content-consent::module.content_consent.title';
        $this->title_singular = 'utility-content-consent::module.content_consent.title_singular';
    ...
    {
        if (user()->cannot('UtilityContentConsent::content_consent.manage')) {
            abort(403);
        }
    }
    ...
    public function index(Request $request)
    {
        ...
        $settings = config('utility-content-consent.content_consent_settings');

        return view('utility-content-consent::content_consent.settings')->with(compact('settings'));
    }
    ...
    {
        return view('utility-content-consent::content_consent.modal');
    }
}
